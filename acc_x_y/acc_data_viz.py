...
data = pkl.load(open("vincent_pushing_2_acc_data_1765318488.40318.pkl", "rb"))
print(len(data))
timestamps = []
x_acceleration = []
y_acceleration = []
...
# print(
#     f"Average timestamp difference between consecutive data points: {avg_time_diff:.6f} seconds"
# )
...
# plt.axhline(
#     y=avg_time_diff, color="r", linestyle="--", label=f"Average: {avg_time_diff:.6f} s"
# )
# plt.legend()
# plt.show()
