 ...
 */
 ...
 bool BaseCommunicator::sendMeasurements(ReceivedData* measurements){
    //  Serial.println("==========Sending measurements==========");
     ...
     if (true || (currentMillis - previousMillis >= interval)) { // TODo): find out why the limit on data send rate was there?
        // Serial.println("==========Sending measurements inside if==========");
         // Save the last time you executed the code
         previousMillis = currentMillis;
         // INSERT_YOUR_CODE
         Serial.print("Sending measurements size: ");
...
//  THIS_IS_DEFINITELY_A_SYNTAX_ERROR;
